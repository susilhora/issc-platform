...
export default function RoadmapsHub() {
  return (
    <div className="min-h-[75vh] flex flex-col items-center justify-center text-center px-6 bg-gray-50">
      ...
      <h1 className="text-4xl font-bold text-gray-900 mb-4">AI Visa Roadmaps</h1>
      <p className="text-gray-500 mb-8 max-w-lg text-lg">Our comprehensive, AI-guided visa step-by-step trackers are being finalized. Check back soon for the complete directory!</p>
